...
*/
		...
		*/
		function centenas($centenas){
				...
				15=>'quince',20=>'veinte',30=>'treinta',40=>'cuarenta',50=>'cincuenta',
				60=>'sesenta',70=>'setenta',80=>'ochenta',90=>'noventa',100=>'ciento',
				102=>'dos',103=>'tres',104=>'cuatro',105=>'quinientos',106=>'seis',107=>'setecientos',
				108=>'ocho',109=>'novecientos');
		...
		*/
		function unidades($unidad){
				...
				60=>'sesenta',70=>'setenta',80=>'ochenta',90=>'noventa',100=>'ciento',
				101=>'quinientos',102=>'setecientos',103=>'novecientos',104=>'cuatrocientos'
				);
				...
				while($valor!=0){
						...
						if(($valor<100000) and ($valor>=10000)){
								...
								if($tempo<16){
										...
										$tempo=$this->decenas(intval($valor/10000)*10);//30
										$letras.=(string) $tempo;
		...
		*/
		function convertir($valor){
				...
				print convertir_a_letras($valor);
