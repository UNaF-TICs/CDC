...
function centena_miles($numero)
{
	if ($numero >= 100)
	{
		if ($numero >= 900 & $numero <= 999)
		{
			...
			if ($numero > 900)
				$num_letra = $num_letra.decena_mil($numero - 900);
		}
		else if ($numero >= 800 && $numero <= 899)
		{
			$num_letra = "ochocientos ";
			...
			if ($numero > 800)
				$num_letra = $num_letra.decena_mil($numero - 800);
		}
		else if ($numero >= 700 && $numero <= 799)
		{
			$num_letra = "setecientos ";
			...
			if ($numero > 700)
				$num_letra = $num_letra.decena_mil($numero - 700);
		}
		else if ($numero >= 600 && $numero <= 699)
		{
			$num_letra = "seiscientos ";
			...
			if ($numero > 600)
				$num_letra = $num_letra.decena_mil($numero - 600);
		}
		else if ($numero >= 500 && $numero <= 599)
		{
			$num_letra = "quinientos ";
			...
			if ($numero > 500)
				$num_letra = $num_letra.decena_mil($numero - 500);
		}
		else if ($numero >= 400 && $numero <= 499)
		{
			$num_letra = "cuatrocientos ";
			...
			if ($numero > 400)
				$num_letra = $num_letra.decena_mil($numero - 400);
		}
		else if ($numero >= 300 && $numero <= 399)
		{
			$num_letra = "trescientos ";
			...
			if ($numero > 300)
				$num_letra = $num_letra.decena_mil($numero - 300);
		}
		else if ($numero >= 200 && $numero <= 299)
		{
			$num_letra = "doscientos ";
			...
			if ($numero > 200)
				$num_letra = $num_letra.decena_mil($numero - 200);
		}
		else if ($numero >= 100 && $numero <= 199)
		{
			if ($numero == 100)
				...
				$num_letra = "ciento ".decena_mil($numero - 100);
		}
	}
	else
		$num_letra = decena_mil($numero);
...
function cien()
{
	...
	$importe_parcial=floatval($importe_parcial);
	/*	while (substr($importe_parcial, 0, 1) == 0)
	{
		echo substr($importe_parcial, 0, 1)."<br>";
		$importe_parcial = substr($importe_parcial, 1, strlen($importe_parcial) - 1);
		echo "BLOCLE $importe_parcial <br>";
	}
	*/
	//echo "QUEDA $importe_parcial";
	//$importe_parcial=".1";
	//if ($importe_parcial >= 0 && $importe_parcial <= 0.99)
	//	$car = 0;
	...
	*/
	...
	if ($parcial > 0)
	{
		if ($parcial == 1)
			...
			$num_letra = centena_miles($parcial)." mil ";
	}
	return $num_letra;
}
