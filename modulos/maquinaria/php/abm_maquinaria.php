...
function agregar_maquinaria($tabla22_imagen,$tabla22_nombre,$tabla22_descripcion,$tabla22_marca,$tabla22_modelo,
$tabla22_fecha_compra,$tabla22_costo_compra,$tabla22_matricula,$tabla22_empresa_seguro,$tabla22_rto,$tabla22_funcion,$pdo)
{
	
	$sql="INSERT INTO tabla_22_maquinaria  
		(
			tabla22_imagen,
			tabla22_nombre,
			tabla22_descripcion,
...
function modificar_maquinaria($id_tabla22,$tabla22_imagen,$tabla22_nombre,$tabla22_descripcion,$tabla22_marca,$tabla22_modelo,
$tabla22_fecha_compra,$tabla22_costo_compra,$tabla22_matricula,$tabla22_empresa_seguro,$tabla22_rto,$tabla22_funcion,$pdo)
{
	if ($tabla22_nombre=="")
	{
	...
	$sql="UPDATE tabla_22_maquinaria  SET 
			tabla22_imagen='$tabla22_imagen',
			...
			tabla22_fecha_compra='$tabla22_fecha_compra',
...
{
				$sql2="DELETE FROM tabla_22_maquinaria WHERE
