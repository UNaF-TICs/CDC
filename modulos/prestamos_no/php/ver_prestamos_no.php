...
$fecha_desde_devolver=$_POST["fecha_desde_devolver_1"];
$fecha_hasta_devolver=$_POST["fecha_hasta_devolver_1"];
...
if ($es_buscar!="")
{
	...
	if ($fecha_desde_devolver!="")
	{
		if ($where=="")
		{
			$where.=" tabla12_fecha_a_devolver >= '$fecha_desde_devolver' ";
		}
		else
		{
	...
	if ($fecha_hasta_devolver!="")
	{
		if ($where=="")
		{
			$where.=" tabla12_fecha_a_devolver <= '$fecha_hasta_devolver' ";
		}
		else
		{
...
inner join tabla_07_personas on id_tabla07 = rela_tabla07
		$where and tabla12_fecha_devolucion is null
...
else
{
	...
	if($offset>1)
	{
		$pag.="<td><a href=\"javascript:cargar_post('modulos/prestamos_no/php/ver_prestamos.php','listado_prestamos_no','offset=$off&id_tablamodulo=$id_tablamodulo');\"><< Anterior</a> | </td>";
	}
	else
	{
		$pag.="<td></td>";
	...
	for($i=$com;$i<=$ter;$i++)
	{
		...
		{
			$pag.="<a href=\"javascript:cargar_post('modulos/prestamos_no/php/ver_prestamos.php','listado_prestamos_no','offset=$i&id_tablamodulo=$id_tablamodulo');\">$i</a>&nbsp;";
		}				 	 
	}
	$pag.="</td>";
					// Siguiente >>
	...
	{
		$ofs=$offset+1;
		$pag.="<td> | <a href=\"javascript:cargar_post('modulos/prestamos_no/php/ver_prestamos.php','listado_prestamos_no','offset=$ofs&id_tablamodulo=$id_tablamodulo');\">Siguiente >></a></td>";
	}else{
		$pag.="<td></td>";
	}
