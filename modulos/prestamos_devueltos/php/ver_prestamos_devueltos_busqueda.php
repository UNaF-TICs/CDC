...
//Archivos comunes
$t->set_file(array(
	"ver"				=> "ver_prestamos_devueltos_busqueda.html",
...
$titulo="Listado de prestamos Devueltos";
...
$url="'modulos/prestamos_devueltos/php/ver_prestamos_devueltos.php'";
$id="'listado_prestamos_devueltos'";
$vars="'es_buscar=si&id_tablamodulo=$id_tablamodulo&";	
$vars.="rela_tabla10='+ver_busqueda_no_prestamos.rela_tabla10.value+'&";
$vars.="rela_tabla07='+ver_busqueda_no_prestamos.rela_tabla07.value+'&";
$vars.="fecha_hasta='+ver_busqueda_no_prestamos.fecha_hasta.value+'&";
$vars.="fecha_desde='+ver_busqueda_no_prestamos.fecha_desde.value+'&";
$vars.="fecha_hasta_devolver='+ver_busqueda_no_prestamos.fecha_hasta_devolver.value+'&";
$vars.="fecha_desde_devolver='+ver_busqueda_no_prestamos.fecha_desde_devolver.value";	
...
where tabla12_fecha_devolucion is not null
