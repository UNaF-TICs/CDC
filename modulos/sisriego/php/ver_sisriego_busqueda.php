...
//Archivos comunes
$t->set_file(array(
	"ver"				=> "ver_sisriego_busqueda.html",
	"un"				=> "un_sisriego.html",
...
$titulo="Listado de sistemas de riego";
$t->set_var("titulo",$titulo);

//
//Otras Funciones
//$t->set_var("funcion_excel","modulos/sisriego/php/exportar_excel.php?tipo=xls");
//$t->set_var("funcion_doc","modulos/sisriego/php/exportar_excel.php?tipo=doc");
//$t->set_var("funcion_pdf","modulos/sisriego/php/exportar_excel.php");
//

$url="'modulos/sisriego/php/ver_sisriego.php'";
$id="'listado_sisriego'";
$vars="'es_buscar=si&id_tablamodulo=$id_tablamodulo&";
$vars.="tabla66_descrip='+ver_busqueda_sisriego.tabla66_descrip.value";
