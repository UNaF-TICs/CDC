...
//Archivos comunes
$t->set_file(array(
	"ver"				=> "ver_prestamos_busqueda.html",
	"un"				=> "un_prestamos.html",
...
$t->set_var("funcion_excel","modulos/prestamos/php/exportar_excel.php?tipo=xls");
$t->set_var("funcion_doc","modulos/prestamos/php/exportar_excel.php?tipo=doc");
$t->set_var("funcion_pdf","modulos/prestamos/php/exportar_excel.php");
//
...
$url="'modulos/prestamos/php/ver_prestamos.php'";
$id="'listado_prestamos'";
$vars="'es_buscar=si&id_tablamodulo=$id_tablamodulo&";	
$vars.="rela_tabla10='+ver_busqueda_prestamos.rela_tabla10.value+'&";
$vars.="rela_tabla07='+ver_busqueda_prestamos.rela_tabla07.value+'&";
$vars.="fecha_hasta='+ver_busqueda_prestamos.fecha_hasta.value+'&";
$vars.="fecha_desde='+ver_busqueda_prestamos.fecha_desde.value+'&";
$vars.="fecha_hasta_devolver='+ver_busqueda_prestamos.fecha_hasta_devolver.value+'&";
$vars.="fecha_desde_devolver='+ver_busqueda_prestamos.fecha_desde_devolver.value";	
...
else
{
	...
	if($offset>1)
	{
		$pag.="<td><a href=\"javascript:cargar_post('modulos/prestamos/php/ver_prestamos.php','listado_prestamos','offset=$off&id_tablamodulo=$id_tablamodulo');\"><< Anterior</a> | </td>";
	}
	else
	{
		$pag.="<td></td>";
	...
	for($i=$com;$i<=$ter;$i++)
	{
		...
		{
			$pag.="<a href=\"javascript:cargar_post('modulos/prestamos/php/ver_prestamos.php','listado_prestamos','offset=$i&id_tablamodulo=$id_tablamodulo');\">$i</a>&nbsp;";
		}				 	 
	}
	$pag.="</td>";
					// Siguiente >>
	...
	{
		$ofs=$offset+1;
		$pag.="<td> | <a href=\"javascript:cargar_post('modulos/prestamos/php/ver_prestamos.php','listado_prestamos','offset=$ofs&id_tablamodulo=$id_tablamodulo');\">Siguiente >></a></td>";
	}else{
		$pag.="<td></td>";
	}
