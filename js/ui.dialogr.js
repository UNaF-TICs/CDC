...
(function($) {
	...
	uiDialogClasses = 'ui-dialog ' + 'ui-widget ' + 'ui-widget-content ' + 'ui-corner-all ';
	...
	$.widget("ui.dialogr", {
	  ...
	  _create : function() {
		  ...
		  if (self.options.maximized) {
			  uiDialogTitlebar.append('<a href="#" id="dialog-maximize" class="ui-dialog-titlebar-max" role="button"><span>Maximizar</span></a>');
	  ...
	  restore : function() {
		 ...
		 $('.ui-dialog-titlebar-min', this.uiDialog).show();
		  ...
		  this.uiDialog.find('#dialog-restore').css('right', '2em');
	  ...
	  minimize : function() {
		 ...
		 $('.ui-dialog-titlebar-rest', this.uiDialog).css('right', '2em');
