...
(function($) {
  ...
  //Funcion Expandir Todos
	$.fn.expandirAll = function() {
		$(this).find("tr").removeClass("collapsed").addClass("expanded").each(function(){
			$(this).expand();
		});
	};
 //Funcion Contraer Todos	
	$.fn.contraerAll = function() {
    ...
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        ...
        if(options.expandable) {
          var newLink = '<a href="#" title="' + options.stringExpand + '" style="margin-left: -' + options.indent_margin + 'px; padding-left: ' + options.indent + 'px" class="expander"></a>';
